---
title: >-
  「Transformer 脱却した」と「Transformer 脱却が default」のあいだ — 5 案 skeleton + 進化型 GA
  で脳の構造そのものを進化させる話
tags:
  - llive
  - mamba
...
![「主語がデカくない?」と訝る明美](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/093.jpg)
> 🗒️ *「何か主語がデカくない…?」—「脱却した」と大きく構える主張への自戒*（© Forbidden shibukawa / SHUEISHA・スナックバス江）
...
![「嘘は良くない」と諭す一コマ](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/196.jpg)
> 🗒️ *「嘘は良くない」— ベンチで自社が異常に速い結果が出ても、勝った気になる前に内訳を疑う。脱却の「解像度」を ✅/❌ で割るのが honest disclosure の作法です。*（© Forbidden shibukawa / SHUEISHA・スナックバス江）
