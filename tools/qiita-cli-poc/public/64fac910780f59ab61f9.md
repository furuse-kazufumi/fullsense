...
updated_at: '2026-06-14T22:28:26+09:00'
...
![「主語がデカくない?」と冷静に指摘するコマ](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/093.jpg)
> 🗒️ *「主語がデカくない？」— 「1日で32件」と盛った見出しに、自分でツッコミを入れておく*（© Forbidden shibukawa / SHUEISHA・スナックバス江）
...
![「つまんね〜」と退屈そうな男](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/145.jpg)
> 🗒️ *「つまんね〜〜!!」— 弱い相手への空虚な勝利(fair benchmark の罠)*（© Forbidden shibukawa / SHUEISHA・スナックバス江）
...
def run_llive(brief: str, _keys: dict) -> tuple[bool, str, float]:
    ...
    cmd = ["py", "-3.11", "scripts/run_brief.py",
