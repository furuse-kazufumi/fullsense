---
title: >-
  「LLM 観測ダッシュボードを TUI で書く」設計の話 ― llove v0.3.0a1 (Textual / layout.toml / F25
  連携基盤)
tags:
  - Python
  - MCP
  ...
  - textual
private: false
updated_at: '2026-06-14T22:29:37+09:00'
id: 932c4cfc6cfca636504a
...
![AI 搭載ブラウザが会話に即答を割り込んでくる場面](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/110.jpg)
> 🗒️ *「即答を割り込んでくる AI ブラウザもいいけれど、運用現場が見たいのは「いまの状態を秒で、SSH 越しに、ラグなく」。だから TUI を選んだ。」* （© Forbidden shibukawa / SHUEISHA・スナックバス江）
...
![キャバクラとスナックの違いを語る場面](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/032.jpg)
> 🗒️ *「キャバクラとスナックが違うように、Web ダッシュボードと TUI も役割が違う。llove は「現場に居座れる観測層」という立ち位置を選んだ。」* （© Forbidden shibukawa / SHUEISHA・スナックバス江）
