...
tags:
  ...
  - 強化学習
private: true
updated_at: '2026-08-23T03:39:09+09:00'
...
なお教師データについては「横撮り動画から階段昇りの教師も作れるのでは」という線も並行で仕込んでいます(15.9 の続報参照 — 横視点で膝の頭打ちが解消したのはまさにこの布石)。公開モーションデータの階段クリップも調査中で、見つかれば模倣の型もぶつけて比較します。
