...
tags:
  ...
  - 強化学習
private: true
updated_at: '2026-08-23T00:21:16+09:00'
...
視覚の部品(距離 −0.23%、重心 3px 一致)は競技より先に合格点に達しました。身体側の把持幾何も、上の続報のとおりオラクルが合格済み。残るは残差 RL がこれを外乱下で維持することで、それが繋がれば「見て、狙って、つまむ」が一本になります。部品が揃っていく過程も、展示だと思って見てください。
...
- **器用さ競技(箸で豆運び)**: 別記事で報告してきた「箸で豆をつまめたのに、持ち上げると落とす」問題に、本記事の歩行で確立した体系(参照モーション+残差 RL+事前宣言ゲート)を移植する作業が始まっています。掴む競技と歩く競技が、同じ道具箱の上で交わる予定です。
