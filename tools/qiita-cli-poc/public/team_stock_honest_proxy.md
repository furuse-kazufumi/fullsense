...
>
> 公式サポートに確認した正解は **100 クレジット＝1 ドル**——実際はその **1/100、ざっと 1 万円相当**で、AI の答えはきっかり **100 倍の過大表示**だった。**AI は、自社の価格表すら、堂々と間違える。** （ちなみに、もし本当に 100 万円が飛ぶのなら、おとなしくこの CPU 縛りを解く **GPU 付き PC を買う**。そっちの方がよほど建設的だ。）
