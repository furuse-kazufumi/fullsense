---
title: >-
  LLM の「忘却」に正面から向き合う ― 4 層メモリ × 形式検証 × TRIZ 自演化 × Rust ホットパスを Python で実装した話
  (llive v0.5.0)
tags:
  - Python
  - Rust
...
updated_at: '2026-06-14T22:30:03+09:00'
id: 6ea53d9ad19f60a23f07
...
![何を話そうとしていたか忘れてしまう人物](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/137.jpg)
> 🗒️ *「あれ…何の話だっけ」— この『忘れる』をアーキテクチャで殴るのが catastrophic forgetting 対策です*（© Forbidden shibukawa / SHUEISHA・スナックバス江）
...
![嘘は良くないと諭す場面](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/196.jpg)
> 🗒️ *「嘘は良くないよ」— だから数字は誇張せず、テスト数も coverage もそのまま晒します（honest disclosure）*（© Forbidden shibukawa / SHUEISHA・スナックバス江）
