---
title: HTML で見えないのに、機械では読める。— llive が採用した「不可視アノテーションチャネル」とは何か
tags:
  - HTML
  - semanticweb
  - アクセシビリティ
...
updated_at: '2026-06-14T22:05:36+09:00'
id: 33b70c801894b91ca826
...
![AI搭載ブラウザが人間に代わってページを読み即答する様子](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/110.jpg)
> 🗒️ *「うわっ もう答え出てきた」 — 人間がスクロールして読む前に、機械（LLM・ブラウザAI）はページの“見えない注釈”まで先回りして読み取ってしまう。（© Forbidden shibukawa / SHUEISHA・スナックバス江）*
...
![「嘘は良くない」と諭すコマ](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/bazue_all/196.jpg)
> 🗒️ *「嘘は良くないわよ」 — 人に見えないチャネルは便利な反面、プロンプトインジェクションの温床にもなりうる。使うなら隠し事にせず、仕様として正直に開示する。（© Forbidden shibukawa / SHUEISHA・スナックバス江）*
