...
2. [Just "measuring with eyeglasses" doesn't make it evolve — selection pressure lldarwin #26](https://fullsense.qiita.com/furuse-kazufumi/items/30a41e73d71e0a36f9ba)
3. [I rebuilt AI evolution overnight #27](https://fullsense.qiita.com/furuse-kazufumi/items/61dda4314c1b786381d0)
...
- ["Once the eyeglasses saturate, selection pressure is powerless" — hardened by refutation #29](https://fullsense.qiita.com/furuse-kazufumi/items/bb2f19dbf60df28deb56)
- Verification arc: [(#35-00) SDP/Lyapunov over SMT](https://fullsense.qiita.com/furuse-kazufumi/items/6fc86b4732eeec77adb6) → [(#35-01) the ladder of checkers](https://fullsense.qiita.com/furuse-kazufumi/items/71f05f901fd9a2de6de5) → [(#35-02) doubt the "too-good numbers"](https://fullsense.qiita.com/furuse-kazufumi/items/ffef66ddbc48d7649615)
...
2. [光「用眼镜测量」并不会进化 — 选择压 lldarwin #26](https://fullsense.qiita.com/furuse-kazufumi/items/30a41e73d71e0a36f9ba)
3. [一夜之间重做了 AI 进化 #27](https://fullsense.qiita.com/furuse-kazufumi/items/61dda4314c1b786381d0)
...
- [「眼镜一旦饱和，选择压便无力」用反证来锤炼 #29](https://fullsense.qiita.com/furuse-kazufumi/items/bb2f19dbf60df28deb56)
- 验证 arc：[(#35-00) 比起 SMT，选 SDP/Lyapunov](https://fullsense.qiita.com/furuse-kazufumi/items/6fc86b4732eeec77adb6) → [(#35-01) 检查器的梯子](https://fullsense.qiita.com/furuse-kazufumi/items/71f05f901fd9a2de6de5) → [(#35-02) 怀疑「太好的数字」](https://fullsense.qiita.com/furuse-kazufumi/items/ffef66ddbc48d7649615)
...
2. [「안경으로 측정」만으로는 진화하지 않는다 — 선택압 lldarwin #26](https://fullsense.qiita.com/furuse-kazufumi/items/30a41e73d71e0a36f9ba)
3. [하룻밤 사이에 AI 진화를 다시 만들었다 #27](https://fullsense.qiita.com/furuse-kazufumi/items/61dda4314c1b786381d0)
...
- [「안경이 포화되면 선택압은 무력」 반증으로 단련한다 #29](https://fullsense.qiita.com/furuse-kazufumi/items/bb2f19dbf60df28deb56)
- 검증 arc: [(#35-00) SMT보다 SDP/Lyapunov](https://fullsense.qiita.com/furuse-kazufumi/items/6fc86b4732eeec77adb6) → [(#35-01) 검사기의 사다리](https://fullsense.qiita.com/furuse-kazufumi/items/71f05f901fd9a2de6de5) → [(#35-02) 「너무 좋은 수치」를 의심하라](https://fullsense.qiita.com/furuse-kazufumi/items/ffef66ddbc48d7649615)
