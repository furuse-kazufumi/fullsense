...
### 1.3 本文は長文歓迎 ([[feedback_qiita_long_form]] 整合)

本文文字数 (body) は **長いほど良い**. Qiita 長尺記事は読み手の retention + SEO + 連載の繋がり強化に効く. 現状最大 16,068 字 (#21) は全く問題なし. むしろ:

- full 10x volume 版 (各 80-150k 字) は次セッション以降の予定 ([[#24_00]] 既述)
- ベンチ詳細 / 数式展開 / 失敗パターン / honest disclosure 内訳 / コード片 / 表 を盛れば 30k 字級も歓迎
- 「冗長なら削れ」は **タイトルだけ** に適用. 本文は密度 × リズム ([[feedback_reader_attention_curve]]) で長尺維持
