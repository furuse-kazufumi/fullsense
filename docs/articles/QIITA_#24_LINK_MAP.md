...
| #16 | QIITA_#16_three_self_spirit_ai_management.md | <https://qiita.com/furuse-kazufumi/items/4d94bde146b83b31d24c> | 2026-05-23 (公開) |
...
| #24-06 | QIITA_#24_06_llm_backend_non_transformer.md | <https://qiita.com/furuse-kazufumi/items/6da5a883fb2ed651edd8> | 2026-05-23 (公開) |
| #24-07 | QIITA_#24_07_observability_governance.md | <https://qiita.com/furuse-kazufumi/items/c5f2077a3399d3fc9b26> | 2026-05-23 (公開) |
...
## lldarwin アーク (連載 #25→#27 — 進化の選択圧 / 開放端) cross-link — 投稿後に URL 埋める

> 読む順: **#24-05 → #25 → #26(設計) → #27(climax)**。各記事は自己完結（リンクは回遊用、読解の前提にしない / [[feedback_qiita_longterm_continuity]]）。限定共有先行→公開フリップ。

| ID | ファイル | Title (要約) | Qiita URL | 投稿日 |
|---|---|---|---|---|
