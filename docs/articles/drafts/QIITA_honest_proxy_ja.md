...
> **閑話休題：紛らわしい「同名」の話**
>
> 念のため——本記事の "perplexity" は評価指標であって、AI 検索サービスの **Perplexity 社とは無関係**だ。……と書きつつ白状すると、この記事を書く少し前、私はその Perplexity に「クレジットの自動課金」について尋ねていた。返ってきた答えは自信満々に「1 クレジット＝1 ドル」。残高表示をそれで換算すると、**「このまま約 100 万円が自動課金されるのか!?」** と血の気が引いた。
>
