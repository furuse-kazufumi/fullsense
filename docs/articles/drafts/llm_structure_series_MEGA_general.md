---
title: 'LLM は「次の一語を当てる機械」― 作って分かった AI の中身、ぜんぶ入り【一般版・完全版】'
tags:
  - AI
  - LLM
  - 入門
...
数式は使いません。絵と比喩だけで、入口から出口まで通れるように書いています。数式とコードで深く納得したい方は、同じ地図を別の高度で通る[技術版・完全版](https://qiita.com/furuse-kazufumi/items/de27af958332c9c38e33)をどうぞ。
...
*このシリーズは、自作の小さな LLM（llcore）を実装しながら書いています。[技術版](https://qiita.com/furuse-kazufumi/items/de27af958332c9c38e33)では、同じテーマを
...
*このシリーズは、自作の小さな LLM を実装しながら書いています。[技術版](https://qiita.com/furuse-kazufumi/items/de27af958332c9c38e33)では、同じテーマ
...
> 数式とコードで納得したい方は、同じテーマの[技術版](https://qiita.com/furuse-kazufumi/items/de27af958332c9c38e33)へどうぞ。
...
*このシリーズは、自作の小さな LLM を実装しながら書いています。[技術版](https://qiita.com/furuse-kazufumi/items/de27af958332c9c38e33)では、同じ注意機構を数式（探し物リストと名札の照合を、
...
[技術版](https://qiita.com/furuse-kazufumi/items/de27af958332c9c38e33)もあります。「絵で分かった」あとに「仕組みで納得したい」方は、そちらもどうぞ。*
...
![校正ループと学習ループの対比図：どちらも「測って、ズレを少し直す」の繰り返し](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/llm_structure_series/diagram_04_training_loop.svg)
...
*このシリーズは、自作の小さな LLM を実装しながら書いています。[技術版](https://qiita.com/furuse-kazufumi/items/de27af958332c9c38e33)では、同じテーマ（KV キャッシュの膨らみ方、
...
*このシリーズは、自作の小さな LLM を実装しながら書いてきました。[技術版](https://qiita.com/furuse-kazufumi/items/de27af958332c9c38e33)では、同じテーマ（モデル選定とライセンス、
