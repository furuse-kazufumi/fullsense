---
title: 'llive 完全解説 (4) — 「収束する脳」B-series: SynapticSelector / UCB1 / Hebbian'
tags:
  - FullSense
  - llive
  - 解説
...
# llive 完全解説 (4) — 「収束する脳」B-series: SynapticSelector / UCB1 / Hebbian

![hero — UCB1 bandit arm selection and score curve](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_hero.svg?v=2)

![連載進捗 (4/8) — 現在: B-series](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_progress.svg)
...
![theme — B-series ε-greedy bandit + UCB1 (animated)](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_theme.svg?v=2)
...
# llive Complete Guide (4) — "The Converging Brain" B-series: SynapticSelector / UCB1 / Hebbian

![hero — UCB1 bandit arm selection and score curve](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_hero_en.svg?v=2)

![series progress (4/8) — current: B-series](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_progress_en.svg)
...
![theme — B-series ε-greedy bandit + UCB1 (animated)](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_theme_en.svg?v=2)
...
# llive 完全解说 (4) — "收敛的大脑" B-series: SynapticSelector / UCB1 / Hebbian

![hero — UCB1 bandit arm selection and score curve](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_hero_zh.svg?v=2)

![连载进度 (4/8) — 当前: B-series](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_progress_zh.svg)
...
![theme — B-series ε-greedy bandit + UCB1 (animated)](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_theme_zh.svg?v=2)
...
# llive 완전 해설 (4) — "수렴하는 뇌" B-series: SynapticSelector / UCB1 / Hebbian

![hero — UCB1 bandit arm selection and score curve](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_hero_ko.svg?v=2)

![연재 진행 (4/8) — 현재: B-series](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_progress_ko.svg)
...
![theme — B-series ε-greedy bandit + UCB1 (animated)](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24/qiita_24_04_theme_ko.svg?v=2)
