...
![摆脱 Qwen 依赖的 5 阶段路线图（从 Stage A 外围强化到 Stage E 非 Transformer 内核的流程）](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_misc/q10/roadmap_5stage_zh.svg)
...
![Qwen 의존에서 벗어나는 5 단계 로드맵 (Stage A 주변 강화부터 Stage E 비 Transformer 코어까지의 흐름)](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_misc/q10/roadmap_5stage_ko.svg)
