...
![Qwen の隙間を llive が補完するメンタルモデル図](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_misc/q11/mental_model.svg)
...
| `5 m/s + 3 s = 8` (dimension error) | **MATH-01 SI dimensional grounding / representation layer** |
...
| `5 m/s + 3 s = 8`（量纲错误） | **MATH-01 SI 量纲 grounding / 表示层** |
...
![llive 补充 Qwen 缝隙的心智模型图](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_misc/q11/mental_model_zh.svg)
...
| `5 m/s + 3 s = 8` (차원 오류) | **MATH-01 SI 차원 grounding / 표현 계층** |
...
![llive 가 Qwen 의 틈새를 보완하는 멘탈 모델 도식](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_misc/q11/mental_model_ko.svg)
