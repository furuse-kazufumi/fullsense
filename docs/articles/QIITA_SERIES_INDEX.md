...
- このインデックスは **navigation 専用**。記事の物理配置（#1〜#13=日付フォルダ / #14〜=root /
  未投稿=drafts）は変更していない。新記事を drafts→root へ昇格・新規投稿したらここに 1 行追記する。
...
- 重複整理・物理リネーム・番号ズレ修正を実施する場合は別タスク（破壊的変更につき要承認）。
