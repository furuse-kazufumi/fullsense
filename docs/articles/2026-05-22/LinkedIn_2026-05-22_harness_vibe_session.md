...
links_deep:
  qiita_24_00: https://github.com/furuse-kazufumi/fullsense/blob/main/docs/articles/2026-05-21/QIITA_%2324_00_llive_tech_series_index.md
  qiita_24_05: https://github.com/furuse-kazufumi/fullsense/blob/main/docs/articles/2026-05-21/QIITA_%2324_05_evolutionary_v0BCDE.md
  ...
  hero_svg_24_05: https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24_05_hero.svg
---
...
- QIITA #24 連載 7 本の冒頭に **animated SVG hero** (SMIL only, no script) を着地 → [連載 index](https://github.com/furuse-kazufumi/fullsense/blob/main/docs/articles/2026-05-21/QIITA_%2324_00_llive_tech_series_index.md)
...
詳細解説は連載 [#24-05 EvolutionLoop](https://github.com/furuse-kazufumi/fullsense/blob/main/docs/articles/2026-05-21/QIITA_%2324_05_evolutionary_v0BCDE.md) に。 hero SVG (animated SMIL) は [こちら](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_24_05_hero.svg)。
...
評価方法は静的固定せず、HELM / BIG-bench / Arena / SWE-bench / AgentBench を月次で追跡更新。 すべての設計判断は統計データ + A/B + 有意性で。 「速い AI」ではなく「速いと思い込ませる構成」を見抜く道具が lleval (5+1 honest disclosure 因子分解) → [#24-08 lleval](https://github.com/furuse-kazufumi/fullsense/blob/main/docs/articles/2026-05-21/QIITA_%2324_08_lleval_eval_framework.md)。
...
- 連載目次 (Qiita 用 markdown, GitHub 内): [QIITA #24 series index](https://github.com/furuse-kazufumi/fullsense/blob/main/docs/articles/2026-05-21/QIITA_%2324_00_llive_tech_series_index.md)
...
- **公開後**: Qiita series URL が確定したら本文中の `github.com/.../QIITA_#24_*.md` を Qiita 投稿 URL に差し替え検討 ([[QIITA_#24_LINK_MAP]] と同様の運用).
