...
> 폰 노이만・파인만. 세계를 대표하는 8개의 지성이, 500세대의 세대 교체를 거쳐
> 계통으로 남는 것은 누구인가——.
>
> 그 결과, 남은 것은 **나（52%）와 예측 부호화의 아버지 칼 프리스턴（48%）
> 두 계통뿐**. 오카 기요시도 그로텐디크도 폰 노이만도 파인만도,
> **단 한 명도 자손을 남기지 못하고, 계통으로 남지 못했다（도태되었다）.**
>
