...
![個体 → lleval（眼鏡＝測る）→ pressure profile → lldarwin（淘汰器＝淘汰する）→ 次世代の親、の2段構造概念図](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/qiita_misc/evolution_arc_lldarwin_complete/concept_two_stage.svg)
...
![baseline vs novelty の diversity_l2 重ね描き。崩壊と維持を 1 枚で対比](https://raw.githubusercontent.com/furuse-kazufumi/fullsense/main/docs/articles/assets/lldarwin_2026_05_26/lldarwin_stage1_diversity_overlay.svg)
