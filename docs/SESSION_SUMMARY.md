...
- さらに 2026-06-19 の pre-patch baseline として、`dry-run` はなお `PATCH update public_id=f06ca92...` / warning 無し / `private: False` を返し、live HTML / API は `f06ca92...` の現 title で `200`、raw `kamikudaki_shishi.svg` も `image/svg+xml` / `200` を返すことを読み取り専用で確認した。
