...
- `qiita44` の publish 前残タスクは、CMA-ES の旧 PDF 差し替えや lexicase 追加ではなく、本文の言い回し強度と参考導線の最終突合、ならびに MIT Press 2 件の到達性確認である。2026-06-18 時点では browser UA 付き GET でも 403 のままなので、実ブラウザで開けるかを確認するか、別の公式導線へ差し替えるかを publish 前に決める。
