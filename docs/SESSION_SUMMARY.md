...
- 記事ネタ評価:
  ...
  - さらに `docs/articles/2026-06-18/llterm_seed6_article_plan.md` を追加し、種 #6 の controlling idea、hook + nut graf、6-beat through-line、種 #1〜#5 の章マッピング、章構成案まで固定した。以後はこの骨格をそのまま Qiita 草稿化できる
- 挿絵索引:
