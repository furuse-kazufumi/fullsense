...
- **real 配線確認**: `--real --pop 4 --gens 1 --max-tasks 1`(founder count=4 が pop 下限。CPU ~88s/task のため pop×gens×task×turn は非現実的 → 1 個体 1 タスクの multi-turn fitness が Docker+ollama を end-to-end で回す配線確認に限定)。
