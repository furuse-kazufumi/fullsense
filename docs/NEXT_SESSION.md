...
7. `qiita45_human_ai_dev_incident_patterns.md` を必要なら推敲する。
   ...
   一次 URL 確認と著者帰属の整備。
8. `qiita47_harness_engineering_thoughts.md` は `#43` から派生した local-only の independent short draft として新設済みで、いまは独立短稿として最低限読める具体節まで入った状態。
