...
10. #46 の publish gate 状態は項目 `4` を正本として追う。JA 正本の HTML annotation は完了済み。翻訳版で残るのは、多言語本文の第8章、endmatter 一式（関連記事 / 参考文献 / HTML annotation メタタグ）、最終見直し。
