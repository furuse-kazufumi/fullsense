...
10. `qiita46_llterm_supervision_first.md` は第8章まで執筆済みで、参考文献・HTML annotation・休憩ポイントも投入済み。`qiita46_llterm_supervision_first_kamikudaki.md` は skeleton 作成済み。publish gate 解除前に残るのは、かみくだき版の磨き込み・多言語・挿絵 `025.jpg` の投入と最終見直し。
