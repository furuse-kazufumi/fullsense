...
1. publish gate 用の別バッチとして、#43 en/zh/ko のうち「約49k件」節まわりと `50手法 vs 96ノート` 節を除く未確認箇所の factual / translation drift を優先して詰める。
...
- 次は #43 en/zh/ko のうち、「約49k件」節まわりと `50手法 vs 96ノート` 節を除く未確認箇所の factual / translation drift を詰める。
