...
|---|---|---|---|
| llive | `d405a33 2026-05-21` | docs(requirements): v0.A — 外部 LLM ランタイム (llama.cpp/GGUF/sampler) 追従要件 | 2026-05-20 12:41 |
...
- `05:43` `docs/SESSION_SUMMARY.md`
- `05:41` `docs/spec/lleval_v0_1_implementation_notes.md`
- `05:34` `docs/NEXT_SESSION.auto.md`
